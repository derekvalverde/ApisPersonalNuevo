...
{
   public class ApiPreguntaRespuestaNroIntentoListarService: IApiPreguntaRespuestaNroIntentoListarService
    {
        private readonly AppSettings _appSettings;
        private readonly AplicacionDbContextCampusVirtual _context;
        public ApiPreguntaRespuestaNroIntentoListarService(IOptions<AppSettings> appSettings, AplicacionDbContextCampusVirtual context)
        {
            _appSettings = appSettings.Value;
            _context = context;
        }
        public List<clsPreguntaRespuestaNroIntentoListarResponse> obtenerPreguntaRespuestaNroIntentoListar(int evuId, int evuNroIntento)
        {
            ...
            cmd.CommandText = "Api_PreguntaRespuestaNroIntentoListar";
